...
const selectTriggerStyles = [
  cx(
    // base
    control,
    "group/trigger flex w-full select-none items-center justify-between gap-2 truncate border px-3 py-2 shadow-xs [--tw-shadow-color:var(--color-black-a5)] outline-hidden lg:transition sm:text-sm",
    // border color
    "border-brd-control",
    // text color
    "text-cnt-primary",
